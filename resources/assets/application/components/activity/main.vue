  ...
  <section class="inline-block fullheight thing-list" :class="{ active:isListActive,noactive:!isListActive }">
    <div v-bar="{preventParentScroll: true,scrollThrottle: 30}" class="full">
      <div id="vbarcontent">
        ...
        <missionlist :thing_list="thing_list" :mode="mode" />
      </div>
    </div>
  </section>
  <!-- 右边区域 -->
...
@media only screen and (max-width: 991px) and (min-width:768px) {
  ...
  /* aside li.ivu-menu-submenu.ivu-menu-item-active.ivu-menu-child-item-active.ivu-menu{
    display: none;
  } */
