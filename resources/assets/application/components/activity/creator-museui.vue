...
<mu-container class="activity-container">
  <mu-form :model="form" class="mu-demo-form" label-position="left" label-width="100">
    ...
    <mu-form-item prop="date" label="From">
      <mu-date-input v-model="form.start_at" type="dateTime" actions ok-label="Ok" cancel-label="Cancel"></mu-date-input>
    </mu-form-item>
    <!-- Deadline -->
    <mu-form-item prop="date" label="To">
      <mu-date-input v-model="form.until_at" type="dateTime" actions ok-label="Ok" cancel-label="Cancel"></mu-date-input>
    </mu-form-item>
    <!-- events?todo -->
    ...
    <mu-form-item>
      ...
      <mu-button @click="clear">clear</mu-button>
    </mu-form-item>
  </mu-form>
</mu-container>
