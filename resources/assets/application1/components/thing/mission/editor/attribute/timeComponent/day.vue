...
<template>
  <div>
    ...
    <FormItem label="Time Range">
      ...
      <TimePicker format="HH:mm" v-model="data.startTime" placeholder="Start time" ></TimePicker>
      <TimePicker format="HH:mm" v-model="data.endTime" placeholder="end time" ></TimePicker>
