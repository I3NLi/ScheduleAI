...
export default {
  ...
  methods: {
    ...
    show_thing: function () {
      ...
      this.$router.push({ name: 'thing_viewer', query: { view:'mission',lid:this.item._id,mode:this.mode,tid:this.item._id}});
    },
    addChild: function () {
    ...
    create_thing: function () {
      window.app.thing.activeThingNode = this;
      this.$router.push({ name: 'thing_creator', query: { view:'mission',lid:this.item._id,mode:this.mode,tid:this.item._id}});
    },
    load_thing: function () {
