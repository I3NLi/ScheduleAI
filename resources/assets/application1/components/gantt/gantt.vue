<template>
<link rel=stylesheet href="utils/css/platform.css" type="text/css">
<link rel=stylesheet href="libs/jquery/dateField/jquery.dateField.css" type="text/css">

<link rel=stylesheet href="utils/css/gantt.css" type="text/css">
<link rel=stylesheet href="utils/css/ganttPrint.css" type="text/css" media="print">
...
<script src="utils/js/ganttUtilities.js"></script>
<script src="utils/js/ganttTask.js"></script>
<script src="utils/js/ganttDrawerSVG.js"></script>
<script src="utils/js/ganttZoom.js"></script>
<script src="utils/js/ganttGridEditor.js"></script>
<script src="utils/js/ganttMaster.js"></script>
